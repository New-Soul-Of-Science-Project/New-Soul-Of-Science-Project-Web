  ...
  'OM:FrQFT:Lepton' =>
    array( url_abs => 'http://www.nsosp.org/de/Quanten-Fluss-Theorie/Leptonen-Modell-Elektron-Positron-Myon-Tauon-Neutrino_de.php',
           ...
           jump_ary => array(
                  ...
                  'OM:FrQFT:Lepton:Berechnung-der-Mechanik-geladen-Lepton' => array( headline_text => 'Berechnung der Mechanik geladener Leptonen'/*, headline_text_short => ''*/),
                    'OM:FrQFT:Lepton:Berechnung-der-Mechanik-geladen-Lepton:Equ-LG-aus-Frequenz-Lambda' => array( headline_text => 'Lep.Mod.1'),
                    'OM:FrQFT:Lepton:Berechnung-der-Mechanik-geladen-Lepton:Equ-EinsteinEnergieLichtQuant' => array( headline_text => $nSOSp_g_formelName_FP_2),
                    'OM:FrQFT:Lepton:Berechnung-der-Mechanik-geladen-Lepton:Equ-E-ele-aequi-zu-Masse' => array( headline_text => $nSOSp_g_formelName_FP_3),
                    'OM:FrQFT:Lepton:Berechnung-der-Mechanik-geladen-Lepton:Equ-Frequenz-aus-Spin-Geschw-Radius' => array( headline_text => 'Lep.Mod.7'),
                    'OM:FrQFT:Lepton:Berechnung-der-Mechanik-geladen-Lepton:Equ-Masse-Radius' => array( headline_text => 'Lep.Mod.12'),
                    'OM:FrQFT:Lepton:Berechnung-der-Mechanik-geladen-Lepton:Equ-Spin-Lep' => array( headline_text => 'Lep.Mod.14'),
                    'OM:FrQFT:Lepton:Berechnung-der-Mechanik-geladen-Lepton:Equ-Spin-Geschw-aus-LG' => array( headline_text => 'Lep.Mod.19'),
                    'OM:FrQFT:Lepton:Berechnung-der-Mechanik-geladen-Lepton:Equ-LG-aus-Spin-Geschw' => array( headline_text => 'Lep.Mod.20'),
                    'OM:FrQFT:Lepton:Berechnung-der-Mechanik-geladen-Lepton:Equ-c-licht-rot-aus-c-spin' => array( headline_text => 'Lep.Mod.28'),
                    'OM:FrQFT:Lepton:Berechnung-der-Mechanik-geladen-Lepton:Equ-r-licht-rot-aus-r-spin' => array( headline_text => 'Lep.Mod.37'),
                    'OM:FrQFT:Lepton:Berechnung-der-Mechanik-geladen-Lepton:Equ-r-spin-aus-Masse-LG' => array( headline_text => 'Lep.Mod.41'),
                    'OM:FrQFT:Lepton:Berechnung-der-Mechanik-geladen-Lepton:Equ-r-wq-rot-aus-r-spin' => array( headline_text => 'Lep.Mod.64'),
                    'OM:FrQFT:Lepton:Berechnung-der-Mechanik-geladen-Lepton:Equ-r-wq-rot-aus-hbar-m-ele-c' => array( headline_text => 'Lep.Mod.66'),
                    'OM:FrQFT:Lepton:Berechnung-der-Mechanik-geladen-Lepton:StarkeWechselwirkung' => array( headline_text => 'Starke Wechselwirkung'/*, headline_text_short => ''*/),
