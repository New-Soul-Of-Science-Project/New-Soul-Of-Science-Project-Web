<?php
  ...
  function FrQFT_f_HTML_BeginHeaderBodyContainer( $site_activ)
  {
    ...
    echo '    <meta name="DC.Date"            content="2026-05-30T14:00+01:00"><!-- Zeitstempel Beispiel: 01.08.2001, 12:00 Uhr, +1 Std. zu Greenwich -->'."\n";
  ...
  function FrQFT_f_HTML_EndDivsNavExtrFootContainerBody()
  {
    ...
    echo '          &nbsp; &nbsp; &#149; &nbsp; &nbsp;'."\n";
    echo '          <a class="footer-version" href="https://github.com/New-Soul-Of-Science-Project/New-Soul-Of-Science-Project-Web/releases/tag/v9.43-d20260530-t1400" target="_blank">v9.43</a>'."\n";
    echo '        </p>'."\n";
    echo '      </div>'."\n";
    echo ''."\n";
    echo '    </div>'."\n";
  ...
  function FrQFT_f_Div_WrapperEnd( $offset)
  {
    ...
    echo $offset.'    <br>'."\n";
    echo $offset.'    <p>'."\n";
    echo $offset.'      Stand 30. Mai 2026, 14:00 CET.'."\n";
    echo $offset.'    </p>'."\n";
    echo $offset.'    <br>'."\n";
