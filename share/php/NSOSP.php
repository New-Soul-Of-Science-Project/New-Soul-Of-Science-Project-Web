<?php
                                ...
                                array( url_abs => 'http://www.nsosp.org/de/Quanten-Fluss-Theorie/First-Prinziples-Neue-Physik.php',
                                       ...
                                       jump_ary => array(
                                              'OM:FrQFT:FirstPrinziples:<init>' => array( Ani_init => ($FrQFT_g_Ani_idx = 0), Fig_init => ($FrQFT_g_Fig_idx = 0), Vid_init => ($FrQFT_g_Vid_idx = 0)),
                                                ...
                                                'OM:FrQFT:FirstPrinziples:Vortext:Existenzprinzip' => array( headline_text => 'Existenzprinzip', headline_text_short => 'Existenzprinzip'),
                                                'OM:FrQFT:FirstPrinziples:Vortext:Eigenschaftsprinzip' => array( headline_text => 'Eigenschaftsprinzip', headline_text_short => 'Eigenschaftsprinzip'),
  ...
  function FrQFT_f_HTML_BeginHeaderBodyContainer( $site_activ)
  {
    ...
    echo '    <meta name="DC.Date"            content="2021-01-21T20:00+01:00"><!-- Zeitstempel Beispiel: 01.08.2001, 12:00 Uhr, +1 Std. zu Greenwich -->'."\n";
  ...
  function FrQFT_f_Div_WrapperEnd( $offset)
  {
    ...
    echo $offset.'    <p>'."\n";
    echo $offset.'      Stand 21. Januar 2021, 20:00 CET.'."\n";
    echo $offset.'    </p>'."\n";
    echo $offset.'    <br>'."\n";
