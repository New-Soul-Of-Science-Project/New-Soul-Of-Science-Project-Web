<?php
  ...
  function FrQFT_f_HTML_BeginHeaderBodyContainer( $site_activ)
  {
    ...
    echo '    <meta name="DC.Date"            content="2022-07-28T09:00+01:00"><!-- Zeitstempel Beispiel: 01.08.2001, 12:00 Uhr, +1 Std. zu Greenwich -->'."\n";
  ...
  function FrQFT_f_Div_WrapperEnd( $offset)
  {
    ...
    echo $offset.'    <p>'."\n";
    echo $offset.'      Stand 28. Juli 2022, 09:00 CET.'."\n";
    echo $offset.'    </p>'."\n";
    echo $offset.'    <br>'."\n";
