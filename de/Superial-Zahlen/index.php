                ...
                'Abstract', subline =>
                  ...
                  array( 'equations',
                    array( equ_text_std => 'SN.Home', equ_autonum_reset => false, latex_tech => 'MathJax', equ_list => array(
                      array( display => 'on',  latex => '{  \s  :=  *( ω\overline{\#} *)_{\#}^{ω}  =  *( \prodx_{ \forall p \in \mathbb{P} } p *)^{ω} \\\ \qquad\qquad\quad\;\;\,  =  ( 2 \cdot 3 \cdot 5 \cdot 7 \cdot 11 \cdot 13 \cdot 17 \cdots )_{\#}^{ω}  \equiv_{kan}  ω^{ω}  }',
                                          label_text => '', label_incr => false),
                    ))),
                  array( 'text', array( text => array(
