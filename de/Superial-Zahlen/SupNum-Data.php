<?php
  ...
  $SupNum_g_Site_ary = array(
    'OM:SupNum:' =>
      ...
      header_pict_name => 'SN/SN_header_v04-01.jpg',
    ...
    'OM:SupNum:Ableitungen-Integrale' => array(
      ...
      jump_ary => array(
        ...
        'OM:SupNum:Ableitungen-Integrale:Integration' => array( headline_text => 'Die Integration'/* , headline_text_short => 'X'*/),
          ...
          'OM:SupNum:Ableitungen-Integrale:Integration:Equ-Intervall-Menge-0-bis-x-superial-kleiner-ganzer-Zahlen-faktorisiert' => array( headline_text => 'SN.AbIn.IN.5'),
          'OM:SupNum:Ableitungen-Integrale:Integration:Equ-Menge-natuerliche-Vorgaenger-xs' => array( headline_text => 'SN.AbIn.IN.6'),
          'OM:SupNum:Ableitungen-Integrale:Integration:Equ-Menge-natuerliche-Vorgaenger-xs-Elemente' => array( headline_text => 'SN.AbIn.IN.7'),
          'OM:SupNum:Ableitungen-Integrale:Integration:Equ-Def-Summe-Zaehlen-von-ganzen-SZ' => array( headline_text => 'SN.AbIn.IN.8'),
          'OM:SupNum:Ableitungen-Integrale:Integration:Equ-Def-Summe-Zaehlen-von-ganzen-Infinitesimalen-SZ' => array( headline_text => 'SN.AbIn.IN.9'),
          'OM:SupNum:Ableitungen-Integrale:Integration:Definition-des-Integrals' => array( headline_text => 'Definition des Integrals'/*, headline_text_short => 'X'*/),
          'OM:SupNum:Ableitungen-Integrale:Integration:Equ-Def-Ableitung-mit-x-plus-s-tel-Kurznotation' => array( headline_text => 'SN.AbIn.IN.15'),
          'OM:SupNum:Ableitungen-Integrale:Integration:Equ-Aequ-Integral-mit-Summe-ueber-Intervall-Menge-a-bis-x-superial-kleiner-ganzer-Zahlen' => array( headline_text => 'SN.AbIn.IN.16'),
          'OM:SupNum:Ableitungen-Integrale:Integration:Equ-Def-Integrale-mit-s-hoch-minus-Eins-Kurznotation' => array( headline_text => 'SN.AbIn.IN.19'),
          ...
          'OM:SupNum:Ableitungen-Integrale:Integration:Equ-Integriere-zu-x2-bis-auf-letzte-Summe' => array( headline_text => 'SN.AbIn.IN.24'),
          'OM:SupNum:Ableitungen-Integrale:Integration:Equ-Summe-superial-kleine-natuerliche-SuperialZahlen-bisOhne-x' => array( headline_text => 'SN.AbIn.IN.27'),
    ...
    'OM:SupNum:Algebraische-Grundlagen' => array(
      url_abs => 'https://nsosp.org/de/Superial-Zahlen/Algebraische-Grundlagen.php',
      url_rel => $Glo_PathRel_back.'../de/Superial-Zahlen/Algebraische-Grundlagen.php',
      titel => 'Algebraische Grundlagen - Die Superial-Zahlen (SN) - Deutsch',
      description => '\name[undertitle]{OM:SupNum:Algebraische-Grundlagen}.\hidden{ — \name[description]{OM:SupNum:Algebraische-Grundlagen}.}',
      keywords => '',
      text_titel_h1 => 'Algebraische Grundlagen',
      text_titel_short => 'Algebraische Grundlagen',
      ...
      jump_ary => array(
        ...
        'OM:SupNum:Algebraische-Grundlagen:PrimSZ' => array( headline_text => 'Superiale Primzahlen'/* , headline_text_short => 'X' */),

        'OM:SupNum:Algebraische-Grundlagen:EindeutigkeitNormalform' => array( headline_text => 'Eindeutigkeit der Normalform'/* , headline_text_short => 'X' */),

        'OM:SupNum:Algebraische-Grundlagen:SIstGeordneterKoerper' => array( headline_text => '\lm{ \mathbb{S} } ist ein geordneter Körper'/* , headline_text_short => 'X' */),

        'OM:SupNum:Algebraische-Grundlagen:SIstKoerper' => array( headline_text => '\lm{ \mathbb{S} } ist ein Körper'/* , headline_text_short => 'X' */),
    ...
    'OM:SupNum:Eigenschaften' => array(
      ...
      jump_ary => array(
        ...
        'OM:SupNum:Eigenschaften:ErzeugungsanzahlBeispiele' => array( headline_text => 'Erzeugungsanzahl in Beispielen'/* , headline_text_short => 'X' */),
    ...
    'OM:SupNum:Eulersche-Zahl-e-Funktion' => array(
      ...
      jump_ary => array(
        'OM:SupNum:Eulersche-Zahl-e-Funktion:<init>' => array( Ani_init => ($FrQFT_g_Ani_idx = 0), Fig_init => ($FrQFT_g_Fig_idx = 0), Vid_init => ($FrQFT_g_Vid_idx = 0)),
          ...
          'OM:SupNum:Eulersche-Zahl-e-Funktion:Vortext:Equ-e-Def-durch-Limes' => array( headline_text => 'SN.EuZa.16'),
    ...
    'OM:SupNum:Primzahlprodukt-Vermutung' => array(
      ...
      jump_ary => array(
        'OM:SupNum:Primzahlprodukt-Vermutung:<init>' => array( Ani_init => ($FrQFT_g_Ani_idx = 0), Fig_init => ($FrQFT_g_Fig_idx = 0), Vid_init => ($FrQFT_g_Vid_idx = 0)),
          ...
          'OM:SupNum:Primzahlprodukt-Vermutung:Vortext:Satz-des-Euklid' => array( headline_text => 'Wissen: Zum ›Satz des Euklid‹'/* , headline_text_short => 'X'*/),
          ...
          'OM:SupNum:Primzahlprodukt-Vermutung:Vortext:MengenPrimfakultaet' => array( headline_text => 'Definition: Die Mengen-Primfakultät', headline_text_short => 'Die Mengen-Primfakultät'),
            'OM:SupNum:Primzahlprodukt-Vermutung:Vortext:Equ-omega-Mengen-Primfakultaet-Def-Produkt-alle-p' => array( headline_text => 'SN.PP.49'),
            'OM:SupNum:Primzahlprodukt-Vermutung:Vortext:Equ-omega-Frag-equiv-kan-MengenPrimfakultaet-omega' => array( headline_text => 'SN.PP.67'),
          ...
          'OM:SupNum:Primzahlprodukt-Vermutung:Vortext:Definition-Primturm-Potenzraster' => array( headline_text => 'Definition: Das Primturm-Potenzraster' , headline_text_short => 'Das Primturm-Potenzraster'),
            'OM:SupNum:Primzahlprodukt-Vermutung:Vortext:Equ-def-pr' => array( headline_text => 'SN.PP.68'),
            'OM:SupNum:Primzahlprodukt-Vermutung:Vortext:Equ-pr-MengenPrimfakultaet-omega' => array( headline_text => 'SN.PP.69'),
            'OM:SupNum:Primzahlprodukt-Vermutung:Vortext:Equ-n-entspricht-pr-n' => array( headline_text => 'SN.PP.70'),

          'OM:SupNum:Primzahlprodukt-Vermutung:Vortext:Lueckenloses-Primturm-Potenzraster' => array( headline_text => 'Definition: Das lückenlose Primturm-Potenzraster' , headline_text_short => 'Das lückenlose Primturm-Potenzraster'),
            'OM:SupNum:Primzahlprodukt-Vermutung:Vortext:Equ-def-lpr-n' => array( headline_text => 'SN.PP.71'),
          ...
          'OM:SupNum:Primzahlprodukt-Vermutung:Vortext:Equ-p-i-entspricht-MengenPrimfakultaet-p-i' => array( headline_text => 'SN.PP.126'),
          'OM:SupNum:Primzahlprodukt-Vermutung:Vortext:Equ-p-i-aus-Vorgaenger-p-i-minus-1' => array( headline_text => 'SN.PP.128'),
          'OM:SupNum:Primzahlprodukt-Vermutung:Vortext:Equ-p-i-ist-lpr-MengenPrimfakultaet-p-i' => array( headline_text => 'SN.PP.129'),
          ...
          'OM:SupNum:Primzahlprodukt-Vermutung:Vortext:Generatives-Primzahl-Induktions-Lemma' => array( headline_text => 'Lemma 4: Generatives Primzahl-Induktions-Lemma', headline_text_short => 'Generatives Primzahl-Induktions-Lemma'),
            'OM:SupNum:Primzahlprodukt-Vermutung:Vortext:Equ-p-i-plus-Eins-aus-Vorgaenger-p-i' => array( headline_text => 'SN.PP.130'),
          ...
          'OM:SupNum:Primzahlprodukt-Vermutung:Vortext:Zaehlen-natuerliche-Zahlen-in-Primzahlen' => array( headline_text => 'Das Zählen der natürlichen Zahlen in Primzahlen'/* , headline_text_short => 'X' */),
            'OM:SupNum:Primzahlprodukt-Vermutung:Vortext:Equ-Definition-der-Menge-P-durch-p-Zaehlen' => array( headline_text => 'SN.PP.131'),
          ...
          'OM:SupNum:Primzahlprodukt-Vermutung:Vortext:Natuerliche-Zahlen-ueber-Zaehlen-der-Primzahlen-rekonstruieren' => array( headline_text => 'Die natürlichen Zahlen über das Zählen der Primzahlen rekonstruieren'/* , headline_text_short => 'X' */),
            ...
            'OM:SupNum:Primzahlprodukt-Vermutung:Vortext:Equ-omega-ist-lueckenlose-MengenPrimfakultaet-omega' => array( headline_text => 'SN.PP.163'),
    ...
    'OM:SupNum:Ueberrationalitaetsvermutung' => array(
      ...
      jump_ary => array(
        'OM:SupNum:Ueberrationalitaetsvermutung:<init>' => array( Ani_init => ($FrQFT_g_Ani_idx = 0), Fig_init => ($FrQFT_g_Fig_idx = 0), Vid_init => ($FrQFT_g_Vid_idx = 0)),
          ...
          'OM:SupNum:Ueberrationalitaetsvermutung:Vortext:Equ-Betrag-Wurze-Zwei-gleich-a-geteilt-b-endlich-rational' => array( headline_text => 'SN.ÜV.3'),
          'OM:SupNum:Ueberrationalitaetsvermutung:Vortext:Equ-Zwei-mal-b-Quadrat-gleich-a-Quadrat' => array( headline_text => 'SN.ÜV.7'),
          'OM:SupNum:Ueberrationalitaetsvermutung:Vortext:Equ-a-ist-beliebig-endlich-oft-durch-2-teilbar' => array( headline_text => 'SN.ÜV.18'),
          'OM:SupNum:Ueberrationalitaetsvermutung:Vortext:Equ-b-ist-beliebig-endlich-oft-durch-2-teilbar' => array( headline_text => 'SN.ÜV.19'),
