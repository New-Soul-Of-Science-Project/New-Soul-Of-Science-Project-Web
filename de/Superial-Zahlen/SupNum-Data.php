    ...
    'OM:SupNum:Ueberrationalitaetsvermutung' => array(
      ...
      jump_ary => array(
        'OM:SupNum:Ueberrationalitaetsvermutung:<init>' => array( Ani_init => ($FrQFT_g_Ani_idx = 0), Fig_init => ($FrQFT_g_Fig_idx = 0), Vid_init => ($FrQFT_g_Vid_idx = 0)),
          ...
          'OM:SupNum:Ueberrationalitaetsvermutung:Vortext:Widerspruchsbeweis-fuer-alle-algebraischen-irrationalen-Koeffizienten' => array( headline_text => 'Widerspruchsbeweis für alle algebraischen irrationalen Koeffizienten'/* , headline_text_short => 'XXX'*/),
          'OM:SupNum:Ueberrationalitaetsvermutung:Vortext:Equ-n-ist-x-te-Potenz-von-m' => array( headline_text => 'SN.ÜV.52'),
          'OM:SupNum:Ueberrationalitaetsvermutung:Vortext:Equ-n-ist-x-te-Potenz-der-Primfak-von-m' => array( headline_text => 'SN.ÜV.59'),
          ...
          'OM:SupNum:Ueberrationalitaetsvermutung:Vortext:Equ-xte-Wurzel-n-als-reine-Potenz' => array( headline_text => 'XXXSN.ÜV.50'),
