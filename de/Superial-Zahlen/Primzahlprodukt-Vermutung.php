      ...
      <?php FrQFT_f_Div_WrapperBegin( '      ', 'OM:SupNum:Eigenschaften'); ?>
          ...
          <?php To_f_Paragraph_list_v1( $Sc_g_Text_replace_ary, $Sc_g_Text_replace_preg_ary, '                ', 'Sc_f_Paragraph',
                ...
                'Berechnung der nächsten Primzahl per Mengenlehre', subline =>
                  'Die Kombination der Mengen-Primfakultät von Primzahlen mit dem lückenlosen Primturm-Potenzraster')),
                  array( 'text', array( text => array(
                    'XXX'."\n".
                    'XXX'."\n".
                    'XXX'."\n".
                  ...
                  array( 'text', array( Shape  => 'derivation', text => array(
                      ...
                      'als Parameter der maximalen lückenlosen Intervall-Menge des Primturm-Potenzrasters \\latexmath{ lpr\!*( n\overline{\#} *) }'."\n".
                      'die nächste Primzahl:'."\n".
                      ''))),
                  array( 'equations',
                    array( equ_text_std => 'SN.PP', equ_autonum_reset => false, latex_tech => 'MathJax', equ_list => array(
                      array( display => 'on',  latex => '{  *( \forall n \in \mathbb{N} *) *( p_{i}, p_{i + 1} \in \mathbb{P} *) *( p_{i} < n \leq p_{i + 1} *) \\\ \qquad\qquad\qquad\qquad\qquad\quad *[  p_{i + 1}  =  lpr\!*( n\overline{\#} *)  *]  }'),
                ...
                TitleVis => 'Beispiele zum Zählen der natürlichen Zahlen in Primzahlen:', ParagraphList => array(
                  array( 'text', array( text => array(
                    ...
                    'XXX'."\n".
                    'XXX'."\n".
                    'Die jeweiligen Primturm-Potenzraster Mengen der hier aufgelisteten Beispiele finden wir in den Beispielen für diese oben.'."\n".
                    'XXX'."\n".
                    'XXX'."\n".
                    'XXX'."\n".
                    'XXX'."\n".
                  ...
                  array( 'equations',
                    array( equ_text_std => 'SN.PP', equ_autonum_reset => false, latex_tech => 'MathJax', equ_list => array(
                      ...
                      // array( display => 'on',  latex => '{  \Leftrightarrow  p_{1}  =  lpr\!*( 1\overline{\#} *)  }'),
                ...
                'Der Beweis der Primzahlprodukt-Vermutung', subline =>
                  ...
                  array( 'text', array( text => array(
                    ...
                    'alle natürlichen Zahlen gebildet werden können:\\footnote{\\const{SupNum_g_footnote_text_FundamentalsatzDerArithmetik}}'."\n".
                    ''))),
                  array( 'equations',
                    array( equ_text_std => 'SN.PP', equ_autonum_reset => false, latex_tech => 'MathJax', equ_list => array(
                  ...
                  array( 'text', array( Shape  => 'derivation', text => array(
                      '\\\\'."\n".
                      'Da das lückenlose Primturm-Potenzraster der Mengen-Primfakultät einer endlichen Primzahl in Formel XXX gleich dieser Primzahl ist'."\n".
                  ...
                  array( 'text', array( text => array(
                    ...
                    'damit ebenfalls zu: \\latexmath{ \omega = pr\!*( \omega\overline{\#} *) }.'."\n",
                  ...
                  array( 'text', array( Shape  => 'derivation', text => array(
                      'ist also wahr, was wir zeigen wollten.'."\n",
                        '\\\\'."\n".
                      ''))),
