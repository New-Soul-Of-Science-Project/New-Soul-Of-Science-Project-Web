...
<?php FrQFT_f_HTML_BeginHeaderBodyContainer( 'OM:SupNum:Primzahlprodukt-Vermutung'); ?>
      ...
      <?php FrQFT_f_Div_WrapperBegin( '      ', 'OM:SupNum:Eigenschaften'); ?>
          ...
          <?php To_f_Paragraph_list_v1( $Sc_g_Text_replace_ary, $Sc_g_Text_replace_preg_ary, '                ', 'Sc_f_Paragraph',
                ...
                'Hyperrationalitätsvermutung', subline =>
                  '')),
                  array( 'text', array( text => array(
                    'Die Hyperrationalitätsvermutung geht davon aus, dass sich die Koordinaten (aus der Menge \\latexmath{ \mathbb{A}_R }) der algebraischen Zahlen\\color{*Bearb}{(Verweis)} immer durch rationale Zahlen'."\n".
                    'aus der Menge \\latexmath{ \mathbb{A} } oder durch einen \\italic{hyperrationalen Bruch} von unendlich großen Primzahlenprodukten endlicher Primzahlen in Nenner und Zähler'."\n".
                    'ausdrücken lassen.'."\n".
                    'Die Wurzel aus Zwei \\latexmath{ \sqrt{2} } wäre demnach Beispielsweise auch ein hyperrationaler Bruch:'."\n".
                    ''))),

                  array( 'text', array( Shape  => 'derivation', text => array(
                      '\\\\'."\n".
                      'Angenommen \\latexmath{ \sqrt{2} } sei ein Beispiel eines hyperrationalen Bruchs und die Funktion \\latexmath{ ord(p, \mathbb{P}) }'."\n".
                  ...
                  array( 'text', array( Shape  => 'derivation', text => array(
                      ...
                      'wären damit teilerfremd\\color{*Bearb}{(Verweis)}:'."\n".
                      ''))),
                  array( 'equations',
                    array( equ_text_std => 'SN.PP', equ_autonum_reset => false, latex_tech => 'MathJax', equ_list => array(
                  ...
                  array( 'text', array( Shape  => 'derivation', text => array(
                      'Verallgemeinert für alle hyperrationalen Zahlen muss ihr Bruch auch negativ oder Null sein können.'."\n".
                      'Daher benötigen wir den Bruch mit Vorzeichen, um die Menge der hyperrationalen Zahlen zu definieren:'."\n".
                      ''))),
                  array( 'equations',
                    array( equ_text_std => 'SN.PP', equ_autonum_reset => false, latex_tech => 'MathJax', equ_list => array(
                ...
                Title => 'Brüche, die Wurzel Zwei annähern …',
                TitleVis => 'Brüche, die Wurzel Zwei annähern:', ParagraphList => array(
                  array( 'headline', array( jump_name => 'OM:SupNum:Primzahlprodukt-Vermutung:Vortext:XXX', text =>
