...
<?php FrQFT_f_HTML_BeginHeaderBodyContainer( 'OM:NPYo:Stein-der-Weisen'); ?>
              ...
              'Das Prinzip der Alchemie – das Prinzip der Wandlungen', 'Sc_f_Paragraph',
                array(
                  ...
                  '\\condb{Alchemie basiert auf einem Prinzip der Transmutation} \\\\'."\n".
                    ...
                    'Diese Vorstellung können wir auch in unseren heutigen Denkmustern gut auf unsere moderne Chemie übertragen.'."\n",
                      'Etwas ungewohnter ist die Erkenntnis, dass diese Vorstellung ebenso auch für unsere Psyche beziehungsweise unsere Persönlichkeitsentwicklung zutrifft.'."\n".
                  ...
                  array( 'text', array( text => array(
                    'Dies ist in meinen Augen eine der zentralsten Fragen unserer Zeit, die sich jeder stellen sollte.'."\n",
                      'Während der Konsum und Materialismus immer ausgeprägter ausfällt, nimmt die Sehnsucht der Menschen nach Ruhe, Muße und Spiritualität sowie'."\n".
                    'nach Verbindung und Zusammenhang mit anderen Menschen gleichfalls stetig zu.'."\n",
                      'Genau diesen Konflikt tragen die Menschen schon seit Jahrhunderten und wahrscheinlich seit Jahrtausenden ebenso in sich und untereinander aus.'."\n".
                  ...
                  array( 'text', array( text => array(
                    'In einem flexiblen, klaren inneren Spiegel können wir uns selber und unsere Welt facettenreich sehen.'."\n".
                    'Daher steht für mich der innere Stein der Weisen, unsere innere Alchemie, im Vordergrund.'."\n",
                  ...
                  array( 'text', array( Shape  => 'quote', text => array(
                        ...
                        addtext => '\\footnote{\\color{*Bearb}{(Primärliteratur einfügen!)} \\\\ Internet: \\\\ \\cite{wiki:SteinDerWeisen:2019}, Legende.}')),
                  ...
                  array( 'text', array( Shape => 'italic', text => array(
                        ...
                        'Er ist unser Lernen und Lehren.'."\n".
                        'Er ist unsere Persönlichkeitsentwicklung.'."\n".
                        'Er ist die Suche nach uns selber, nach unserer Persönlichkeit.'."\n".
                  ...
                  array( 'text', array( text => array(
                    'Ein wunderbares Rätsel, dass den Leser zum Nachdenken anregt.'."\n".
                  ...
                  array( 'text', array( text => array(
                    ...
                    'Unser Leben ist in diesem Sinne ein Rätsel, was jeder nur für sich lösen kann, ein Mysterium.'."\n".
                    'Das überlieferte Rätsel soll spätestens der Beginn unserer Suche sein, es soll zur Suche anregen.'."\n",
                      'Das materielle spielt in unserem Leben natürlich eine große Rolle.'."\n".
            ...
            'OM:NPYo:Stein-der-Weisen:Heiliger-Gral',
              'In seine Mythologie des Verlusts kann der Verlust eines wesentlichen Pols unseres Lebens und unserer Gesellschaft hineininterpretiert werden', 'Sc_f_Paragraph',
                array(
                  ...
                  array( 'bulletlist', array( bullet_ary => array(
                        'Das heilige Gefäß soll Glückseligkeit, ewige Jugend oder ewige Lebenskraft spenden.\\color{*Bearb}{(Verweis)}',
                  ...
                  array( 'text', array( text => array(
                    ...
                    'Diese war und ist so nachhaltig, dass sie bis heute noch existiert oder nachwirkt.'."\n",
                  ...
                  '\\condb{Eine Schlange verschwindet} \\\\'."\n".
                    ...
                    'Steht das Verschwinden der zweiten Schlange möglicherweise dafür, die polare Symbolisierung zweier Geschlechter auf eines, das männliche, zu reduzieren?'."\n",
                      ...
                      'Das Weibliche wurde und wird vielleicht immer noch von der Kirche als das Sündige und Böse interpretiert.'."\n".
                    'Wo dies ist, ist für die christliche Kirche wohl keine Frage.'."\n".
                  ...
                  array( 'text', array( text => array(
                    'Wir erleben es heute als ganz besonders intensiv, finde ich, aber es ist uralt.'."\n".
                    'Gesellschaftliche Pole, die genutzt werden zur Befeuerung von Konflikten, nach belieben oft auch umgekehrt, sind:'."\n"))),
                  array( 'bulletlist', array( bullet_ary => array(
                  ...
                  array( 'text', array( text => array(
                    'Und so weiter, to be continued …'."\n",
                      'Die Nutzung dieser Macht über die Pole führt uns in Situationen, wo wir hinterher nicht mehr wissen, wie wir in sie hineingeraten sind,'."\n".
                    'weil der Konflikt solcher Pole unsere Gefühle und unser Handeln stark manipulierbar macht.'."\n".
                  ...
                  array( 'text', array( Shape  => 'quote', text => array(
                        ...
                        addtext => '~aus dem Zen?\\color{*Bearb}{(Verweis)}')),
                  ...
                  array( 'text', array( text => array(
                    ...
                    'Das ist auch ein naturphilosophisches Prinzip, welches sowohl für unser Inneres und unser Äußeres gilt.'."\n",
                      'Solche Kräfte, die durch Brüche erzeugt werden, äußern sich zum Beispiel in persönlichen Traumata, die zu unseren inneren Konflikten führen, und in gesellschaftlichen Konflikten.'."\n".
                    'Ihre Pole sind die Gegensätze dieser unserer Zerrissenheit.'."\n",
                      'Die Kräfte und Pole lassen sich also durch Brüche, wie Traumata, erzeugen und instrumentalisieren.'."\n".
                    'Sie sind aber auch für jedes Leben völlig normal, sie erzeugen erst seine und damit unsere Existenz.'."\n".
