<?php
  ...
  $NPYo_g_Site_ary = array(
    'OM:NPYo:' =>
      array_merge(
        $nSOSp_g_info_wolfgangHuss,
        array(
      url_abs => 'https://nsosp.org/de/Naturphilosophie-Yoga/',
    ...
    'OM:NPYo:Home' => array(
      url_abs => 'https://nsosp.org/de/Naturphilosophie-Yoga/index.php',
    ...
    'OM:NPYo:Energie-Esoterik-Spiritualitaet' => array(
      ...
      titel => 'Esoterisch spirituelle Energie und die Physik - Naturphilosophie-Yoga (NaPhil-Yoga) - Deutsch',
      description => '\\name[undertitle]{OM:NPYo:Energie-Esoterik-Spiritualitaet}. — \\name[description]{OM:NPYo:Energie-Esoterik-Spiritualitaet}.',
      keywords => '',
      text_titel_h1 => 'Esoterisch spirituelle Energie und die Physik',
      text_titel_short => 'Esoterisch spirituelle Energie und die Physik',
      text_undertitel_h2 => 'Der für manche Menschen defuse Energiebegriff der Esoterik und seine teils verborgene Verbindung zur Physik',
      text_titel_discr_h3 => '\\quote{Panta rhei} — Alles fließt!',
      jump_ary => array(
        'OM:NPYo:Energie-Esoterik-Spiritualitaet:<init>' => array( Ani_init => ($FrQFT_g_Ani_idx = 0), Fig_init => ($FrQFT_g_Fig_idx = 0), Vid_init => ($FrQFT_g_Vid_idx = 0)),
    ...
    'OM:NPYo:ExistenzLeichtigkeit' => array(
      url_abs => 'https://nsosp.org/de/Naturphilosophie-Yoga/Existenz-Leichtigkeit-Yin-Yang-Prinzip-Tai-Chi-Djet-Neheh-Wu-Wei-Fluss-Weg-Dao-Daoismus.php',
