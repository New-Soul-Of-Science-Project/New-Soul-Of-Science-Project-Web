...
<?php FrQFT_f_HTML_BeginHeaderBodyContainer( 'OM:FrQFT:Diskussion'); ?>
              ...
              'Eine Analyse des neuen Zeitverständnisses', 'Sc_f_Paragraph',
                ...
                'Der Zeitpfeil')),
                  array( 'text', array( text => array(
                    ...
                    'Der Zeitpfeil ist also in der Feinstruktur des Raums festgelegt und unumkehrbar.'."\n".
                    ...
                    'Im Fall eines Lichtteilchens entartet diese Sphäre zu einer Art Kegel. Dieser Kegel ist wie ein Zeitpfeil, der in die Richtung zeigt, wo sich das Photon hinbewegen wird, also in die Zukunft. Auch die Kausalitätssphären von langsameren Teilchen weißen in die Richtung, in die sich die Teilchen bewegen. Auch wenn die Sphäre hier noch nicht pfeilförmig aussieht, so trägt die Sphäre eine Verzerrung in sich, die in die Zukunft weißt.'."\n".
                    'Die Verzerrung der Kausalitätssphären ist nur zu vermeiden, wenn sich nichts bewegt. Eine Physik in der sich nichts bewegt macht allerdings wenig Sinn.'."\n",
                      'Kehrt man die Zeit um, so stülpt sich der Kausalitätskegel eines Photons in die andere Richtung um. Auch die Kausalitätssphären der langsameren Teilchen werden in deren Bewegungsrichtung gespiegelt. Damit ist die Feinstruktur der physikalischen Realität bei vorwärts laufender Zeit zu einem bestimmten Zeitpunkt nicht die gleiche, wie bei rückwärts laufender Zeit. Eine Umkehr der Zeit lässt das Geschehen also nicht einfach rückwärts laufen. Es werden sich im Laufe der Zeit auch im Makroskopischen Unterschiede ergeben.'."\n".
                    'Physikalische Gesetze, die die endliche Ausbreitungsgeschwindigkeit der Wechselwirkungen berücksichtigen, sind damit in der Zeit nicht umkehrbar. Oder verstehe ich etwas verkehrt?'."\n",
            ...
            'OM:FrQFT:Diskussion:Relativitaet-und-Michelson-Morley-Experiment',
              'Verwirklichung ihrer wesentlichen Eigenschaften, ihr Gültigkeitsbereich und die lorenzianische Interpretation', 'Sc_f_Paragraph',
                array(
                  ...
                  array( 'text', array( text => array(
                      // • Die FrQFT entspringt einer auf ein absolutes Bezugssystem vereinfachten, Speziellen Relativitätstheorie – der Lichtmedium-Theorie.
                      //     Wenn nun die Frage gestellt wird, wie in diesem System die der Zeit gegenläufige Frequenzveränderung erklärt werden kann und
                      //     dieses Problem über das Pound-Rebka-Snider-Experiment angegangen wird, so landet man über die Einführung der Wirkungsquanten, die
              ...
              'Das Relativitätsprinzip wird abgeschwächt', 'Sc_f_Paragraph',
                array(
                  ...
                  array( 'normal',
                    ...
                    'ein ausgezeichnetes Bezugssystem in Form des Fixsternhimmels einführt:'."\n"),
                  array( 'quote',
                    array( text =>  'Zusammenfassend stellen wir fest: \\\\'."\n".
                                    '• Ein Inertialsystem [in der Allgemeinen Relativitätstheorie] ist durch ein Bezugssystem gegeben, von dem aus die Massenverteilung des'."\n".
                                    'Universums [– des Kosmos (in der Quanten-Fluss-Theorie) –] im Großen und im Mittel isotrop ist[, also in jede Richtung gleich].'."\n".
                  ...
                  array( 'normal',
                    'Das bekannte relativistische Prinzip wird abgeschwächt, weil es „nur“ scheinbar gültig ist, was ich trotz dessen sehr bemerkenswert finde.'."\n".
                    'Daher ist die Spezielle Relativitätstheorie natürlich nicht ganz verkehrt und wird überall, wo dies zur einfachen Handhabung führt, zum Beispiel,'."\n".
                    'wenn das Bezugssystem des Fixsternhimmels nicht bekannt ist, weiterhin Anwendung finden. \\\\'."\n".
                    'In der Quanten-Fluss-Theorie ist die Lichtgeschwindigkeit in Bezug auf jeden Beobachter und auf die Gravitation nicht wirklich im dreidimensionalen Raum konstant,'."\n".
                    'sondern erscheint in Form der konstanten Geschwindigkeit der Wirkungsquanten in abgewandelter Größe neu.'."\n".
                    'Daher basiert die Quanten-Fluss-Theorie nicht auf einer vierdiemensionalen Raumzeit, wie die Relativitätstheorie.'."\n".
                    'Da Raum und Zeit in der neuen Theorie aus Bewegung entspringen wird der Begriff'."\n".
                    'Raumzeit durch den neuen Begriff des Bewegungsraums abgelöst.'."\n".
                    'Dies können sogar verschiedene Bewegungen sein, die unterschiedliche Zeiten mit sich bringen.'."\n".
                    'Aus diesem Grund erscheint der Begriff Raumzeit, mit der Bedeutung, dass die Zeit eine quasi räumliche Eigenschaft besitzt, nicht mehr Sinnvoll.'."\n"),
                  array( 'normal',
                    'Daraus resultiert letztlich, dass die gekrümmte Raumzeit der Allgemeinen Relativitätstheorie nur scheinbar gekrümmt ist.'."\n".
                  ...
                  array( 'normal',
                    ...
                    'wird.'."\n".
                    'Dies führt zu einer anderen Form der Gravitationsbeschreibung, die in erster Näherung der Allgemeinen Relativitätstheorie entspricht.'."\n".
                  ...
                  array( 'normal',
                    'Abschließend möchte ich ein paar, meinen Ansatz unterstützende Aussagen von Wissenschaftler zu diesem Thema anfügen, da mein Vorgehen sicher nicht für jeden'."\n".
                    'unumstritten ist.'."\n"),
                  array( 'normal',
                    'Robert B. Laughlin äußert beispielsweise: (in der Einleitung verwendet)'."\n"),
                  array( 'quote',
                    array( text =>  'Die Relativität sagt eigentlich nichts darüber aus, ob es eine das Universum durchdringende Materie gibt oder nicht, sondern nur,'."\n".
                  ...
                  array( 'quote',
                    array( text =>  'Wenn Einstein heute leben würde, wäre er entsetzt über diesen [heutigen] Zustand der Dinge.'."\n".
                                    ...
                                    'und die daraus resultierende Vermehrung logischer Inkonsistenzen in blinden Zorn geraten.'."\n".
                                    'Einstein war Künstler und Gelehrter, aber vor allem war er Revolutionär.'."\n".
                                    'Seine Herangehensweise an die Physik könnte man so zusammenfassen: minimale Hypothesenbildung, niemals experimentellen Befunden widersprechen,'."\n".
                                    'vollkommene logische Konsistenz fordern und unbegründeten Überzeugungen misstrauen.'."\n".
                                    'Die unbegründete Überzeugung seiner Zeit war der Äther, genauer gesagt, die der Relativität vorangehende naive Version des Äthers.'."\n".
                                    'Die unbegründete Überzeugung unserer Zeit ist die Relativität selbst.'."\n".
                                    'Es würde vollkommen seinem Naturell entsprechen, sich die Fakten erneut vorzunehmen, sie im Geist umzuwerfen und zu dem Schluss zu kommen,'."\n".
                                    'dass sein geliebtes Relativitätsprinzip keinesfalls fundamental, sondern emergent ist – eine kollektive Eigenschaft der die Raumzeit'."\n".
                                    'konstituierenden Materie, die bei großen Längenskalen zunehmend exakt wird, bei kurzen hingegen versagt.'."\n".
                                    'Diese Vorstellung unterscheidet sich von seiner ursprünglichen Idee, ist aber logisch damit vollständig vereinbar und sogar aufregender'."\n".
                  ...
                  array( 'jumplist', array(
                      ...
                      array(  jump_name => '*Schwarze-Loech-Zusamm'),
                  )),
              )
          ); ?>
              ...
              '', 'Sc_f_Paragraph',
                array(
                  ...
                  array( 'jumplist', array(
                      ...
                      array(  jump_name => 'OM:FrQFT:Diskussion:LebenFrQFT'),
                    )),
              )
          ); ?>
