...
<?php FrQFT_f_HTML_BeginHeaderBodyContainer( 'OM:FrQFT:Universum-SchwarzeLoecher-Kosmos-Urknall'); ?>


      <?php FrQFT_f_Div_Header( '      '); ?>


      <?php FrQFT_f_Div_WrapperBegin( '      ', 'OM:FrQFT:NeuePhysik:Fraktales-Universum'); ?>
          ...
          <?php To_f_Chapter_v1( $Sc_g_Text_replace_ary, $Sc_g_Text_replace_preg_ary, '          ', 'hideContent',
            'OM:FrQFT:Universum-SchwarzeLoecher-Kosmos-Urknall:XXX',
              '\\color{*Bearb}{In Arbeit …}', 'Sc_f_Paragraph',
                array(
                  array( 'jumplist', array(
                      array(  jump_name => 'OM:FrQFT:Universum-SchwarzeLoecher-Kosmos-Urknall', type => 'back'),
                    )),
