...
<?php FrQFT_f_HTML_BeginHeaderBodyContainer( 'OM:FrQFT:FirstPrinciples'); ?>
          ...
          <?php To_f_Paragraph_list_v1( $Sc_g_Text_replace_ary, $Sc_g_Text_replace_preg_ary, '                ', 'Sc_f_Paragraph',
                array(
                  array( 'notice', array( Display => 'hideContent', text => array(
                    ...
                    '• \bold{Prinzip der minimalen Wirkung:}',
                    '– Veritasium: \jump[https://www.youtube.com/watch?v=Q10_srZ-pbs&t=26s][][_blank]{}{The Closest We’ve Come to a Theory of Everything}.'."\n",
                    '– Sabine Hossenfelder: \jump[https://www.youtube.com/watch?v=A0da8TEeaeE][][_blank]{}{The Closest We Have to a Theory of Everything}.'."\n",
                ...
                'Raum-Zeit-Prinzip', subline =>
                  ...
                  array( 'bulletlist', array( bullet_ary => array(
                        'Raumprinzip: Konstante Bewegung greift Raum, der dann in konstanter Geometrie erscheint.'."\n".
                          'Verändert sich ihre Geschwindigkeit über den Raum, krümmt dies die Erscheinung der Geometrie des Raums.',
                        'Zeitprinzip: Konstante Bewegung in einem Ding ist Uhren gleich.'."\n".
