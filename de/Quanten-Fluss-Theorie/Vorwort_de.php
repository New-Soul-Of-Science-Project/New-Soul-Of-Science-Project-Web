...
<?php FrQFT_f_HTML_BeginHeaderBodyContainer( 'OM:FrQFT:Vorwort'); ?>
          ...
          <?php To_f_Paragraph_list( $Sc_g_Text_replace_ary, $Sc_g_Text_replace_preg_ary, '                ',
                array(
                  ...
                  array( 'text', array( text => array(
                    'Eine meiner Leidenschaften besteht darin, neue Perspektiven auf das Leben und unsere Welt zu entwickeln;'."\n".
                    'mit den Dingen herumzuspielen, die man oft für selbstverständlich und für klar hält, um die Dinge zu durchdringen, die einem Rätsel aufgeben.'."\n".
                    'Ich mag es, meine Intuitionen fließen zu lassen, um die Welt in der ich lebe besser zu verstehen.'."\n".
                    'Dabei gewinne ich bis heute neue Einsichten, von denen etliche sehr spannend und aufregend sind.'."\n".
                  ...
                  array( 'text', array( text => array(
                    ...
                    'Doch die Formeln der beiden Energien und die Vorstellungen davon, was sie bedeuten könnten, schienen mir kaum etwas gemein zu haben, und das, obwohl sich die eine Energieform in die andere verwandeln kann.'."\n".
                    'Ich tat mich schwer mir ein Bild davon zu machen, was die kinetische und die potenzielle Energie in Bezug auf ihre jeweiligen Formeln in einer gemeinsamen strukturellen Ursache miteinander verbindet.'."\n".
                    'Denn die kinetische Energie basiert, wie ihr Name ausdrückt, vereinfacht gesagt auf der Bewegung eines massebehafteten Körpers, kurz einer Masse.'."\n".
                    'Sieht man von der Größe der Masse des bewegten Körpers ab, dann verändert sich seine kinetische Energie nicht, wenn sich die Bewegung nicht ändert.'."\n".
                    'Während die potenzielle Energie auf einer Ruhelage bassiert, auf der Lage einer Masse im Raum, im Gravitationsfeld einer anderen Masse.'."\n".
                    'Die potenzielle Energie einer Masse im Gravitationsfeld eines anderen Körpers verändert sich nicht, wenn ihre Lage sich nicht ändert, also bei Ruhe, sieht man von der Größe der Masse beider Körper ab.'."\n".
                    ...
                    'innerhalb des der Gravitation ausgesetzten Körpers oder Teilchens handeln musste.'."\n".
                    ...
                    'Dies reicht mittlerweile weit hinein in viele Details der Teilchen- und Astrophysik und schließlich bis zur quantitativen Erklärung der Quantengravitation der Elementarteilchen.'."\n".
                    'Es wird klar, dass in dieser neuen Physik alle Wechselwirkungen den Symmetriebrüchen der ihr zugrunde liegenden Strukturen entspringen.'."\n".
                    'Über diesen Weg kommt man zu einer Vorstellung davon, um was es sich beim Grundprinzip der Physik wohl handelt.'."\n".
                    'Was ich besonders erfreulich finde.'."\n".
                    'Denn ich wollte immer schon begreifen, welche Philosophie hinter unserer \\hidden{physischen }Existenz steckt.'."\n".
                  ...
                  array( 'text', array( text => array(
                    ...
                    'Mir fiel es dabei nicht immer leicht zu entscheiden, wo neue Begriffe notwendig sind und an welchen Stellen alte bleiben dürfen.'."\n".
                    'Wenn ich einen alten Begriff beibehalte, so hat der Leser oft ganz konkrete Vorstellungen darunter, während sich das Bild zum Begriff im Laufe'."\n".
                    'der Entwicklung der Theorie etwas verändert.'."\n".
                ...
                'Der Sinn und Zweck von Theorien', subline =>
                  'Wir Menschen stehen im Mittelpunkt!')),
                  array( 'text', array( text => array(
                    'Ganz gleich, wie und warum wir Theorien so oder anders bewerten, es sollte möglichst transparent geschehen, die Gründe dafür sollten angegeben werden.'."\n".
                    'Selbst, wenn wir eine Theorie für zu schön, um nicht wahr zu sein, halten, wir sie lieben oder hassen, wir sie für nicht nützlich halten, wir sollten dies bennenen.'."\n".
                    'Alle Beweggründe sind völlig in Ordnung und ganz menschlich.'."\n".
                    'Wir können nicht völlig objektiv sein.'."\n".
                    'Glauben wir das, lügen wir uns selber in die Tasche und allen anderen was vor.'."\n",
                      'Egal welchen Grund wir angeben, er läuft am Ende darauf hinaus, warum wir eine Theorie für nützlich oder unnütz halten.'."\n".
                ...
                'Das Zeitalter des Postempirismus bricht an?', subline =>
                  'Für mich und viele andere Physiker unvorstellbar!')),
                  array( 'text', array( text => array(
                    'Die Verzweiflung mancher akademischer Physiker geht mittlerweile schon so weit, dass sie ansetzen, das Zeitalter des sogenannten Postempirismus auszurufen.\\footnote{Vgl. \\cite{Hossenfelder:DasHaesslicheUniversum:2018}, S. 277-278.}'."\n".
                    'Das bedeutet so ungefähr, dass neue, aus unterschiedlichen Gründen für vielversprechend gehaltene Theorien, wie die Stringtheorie von einigen von ihnen angesehen wird,'."\n".
                    'nicht mehr durch eine experimentelle Bestätigung ihrer vorhergesagten Phänomene zur Gültigkeit kommen.'."\n".
                    'Sie sollen schon einfach deshalb gelten, weil es angeblich keine ernst zu nehmenden Alternativen gibt.'."\n",
                      'Dies wäre so, als wenn ein Flugzeug schon deshalb zu einem funktionierenden Flugzeug erklärt würde, weil man einen vermeintlich guten Plan hat und schon einmal'."\n".
                  ...
                  array( 'text', array( text => array(
                    'Wer will, kann in ein solches „Flugzeug“ gerne einsteigen und sich in die Lüfte träumen, aber in der Realität vorerst trotz aller Träume am Boden verweilen.'."\n".
                    'Dabei bin ich bestimmt der letzte, der etwas gegen hochfliegende Träume und viel Fantasie hat.'."\n",
                      'Ich werde nicht dabei sein, die Wissenschaft, aufgrund von Angst vor der Prüfung an der Realität, Fantasielosigkeit, Ungeduld und Risikomangel, zu verstümmeln und damit zum zahnlosen Tiger zu machen.'."\n".
                    'Und ich kann dies auch niemandem empfehlen, der ehrlich an Wissenschaft und an wahrhaftigem Wissen interessiert ist.'."\n"))),
                  array( 'text', array( text => array(
                    'George Ellis and Joe Silk schreiben dazu:'."\n"))),
                  array( 'text', array( Shape  => 'quote', text => array(
                        'Jede wissenschaftliche Theorie muss falsifizierbar sein.'."\n"),
