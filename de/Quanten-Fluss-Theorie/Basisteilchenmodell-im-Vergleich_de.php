          ...
          <?php To_f_Paragraph_list( $Sc_g_Text_replace_ary, $Sc_g_Text_replace_preg_ary, '                ',
                ...
                'Genial!', subline =>
                  ...
                  array( 'jumplist', array(
                      array(  jump_name => 'OM:FrQFT:Basisteilchenmodell:Gravitation'),
                    )),
                )
          ); ?>
		    	<br>
            ...
            'OM:FrQFT:Basisteilchenmodell:Gravitation',
              'Im Basisteilchenmodell hat jedes Elementarteilchen die gleiche Quantengravitation. Die Quanten-Fluss-Theorie beschreibt die Quantengravitation der Elementarteilchen realistisch nach deren Masse', 'Sc_f_Paragraph',
                array(
                  ...
                  array( 'jumplist', array(
                      array(  jump_name => 'OM:FrQFT:Basisteilchenmodell:Elementarteilchen-im-Gravitationsfeld'),
                    )),
              )
          ); ?>
            ...
            'OM:FrQFT:Basisteilchenmodell:Elementarteilchen-im-Gravitationsfeld',
              '', 'Sc_f_Paragraph',
                array(
                  ...
                  array( 'text', array( text => array(
                    'Bestimmte Eigenschaften von Elementarteilchen im Gravitationsfeld werden vom Basisteilchenmodell abweichend von den Beobachtungen'."\n".
                    'und auch abweichend von ihren Eigenschaften in der Quanten-Fluss-Theorie beschrieben:'."\n"))),
                  array( 'bulletlist', array( bullet_ary => array(
                        '\\condb{Shapiro-Verzögerung:}'."\n".
                          'Die Änderung der Lichtgeschwindigkeit im Gravitationsfeld und damit die Eigenzeit von Elementarteilchen ist den experimentellen Beobachtungen formell sehr ähnlich.'."\n".
                ...
                'Lichtgeschwindigkeitsänderung im Gravitationsfeld', subline =>
                  ...
                  array( 'text', array( text => array(
                    ...
                    'wobei es nach Formel \\jumpname{OM:FrQFT:Basisteilchenmodell:Elementarteilchen-im-Gravitationsfeld:Equ-BasGraLGEinstein}'."\n".
                    'die gravitative Masse durch die Anzahl \\term{N} der Basisteilchen beziehungsweise durch die doppelte Anzahl ihrer Elementarteilchen ausdrückt.'."\n".
                    'Klein \\term{g} entspricht der an diesen neuen Zusammenhang angepassten Gravitationskonstante groß \\term{G}.'."\n",
                ...
                'Kein Widerspruch in der fraktalen Quanten-Fluss-Theorie', subline =>
                  ...
                  array( 'figure',
                    array_merge( $FrQFT_g_figure_ary_Lepton_highRes, array( name => 'OM:FrQFT:Basisteilchenmodell:Elementarteilchen-im-Gravitationsfeld:Ani-Lepton',
                  ...
                  array( 'jumplist', array(
                      array(  jump_name => 'OM:FrQFT:Basisteilchenmodell:Dunkle-Materie'),
                    )),
              )
          ); ?>
          ...
          <?php To_f_Chapter_v1( $Sc_g_Text_replace_ary, $Sc_g_Text_replace_preg_ary, '          ', 'invis',
            'OM:FrQFT:Basisteilchenmodell:Dunkle-Materie',
              '', 'Sc_f_Paragraph',
                array(
                  array( 'jumplist', array(
                      array(  jump_name => 'OM:FrQFT:Basisteilchenmodell:Elementarteilchen-im-Gravitationsfeld', type => 'back'),
                    )),
          ...
          <?php To_f_Chapter_v1( $Sc_g_Text_replace_ary, $Sc_g_Text_replace_preg_ary, '          ', 'invis',
            'OM:FrQFT:Basisteilchenmodell:Vakuum-und-virtuelle-Teilchen',
              'Das Basisteilchenmodell kennt nicht das Vakuum mit virtuellen Teilchen', 'Sc_f_Paragraph',
                array(
                  array( 'jumplist', array(
                      array(  jump_name => 'OM:FrQFT:Basisteilchenmodell:Dunkle-Materie', type => 'back'),
                    )),
