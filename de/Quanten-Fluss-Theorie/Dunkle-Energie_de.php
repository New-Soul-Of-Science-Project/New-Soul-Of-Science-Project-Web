...
<?php FrQFT_f_HTML_BeginHeaderBodyContainer( 'OM:FrQFT:Dunkle-Energie'); ?>


      <?php FrQFT_f_Div_Header( '      '); ?>


      <?php FrQFT_f_Div_WrapperBegin( '      ', 'OM:FrQFT:Universum-SchwarzeLoecher-Kosmos-Urknall'); ?>
          ...
          <?php To_f_Paragraph_list( $Sc_g_Text_replace_ary, $Sc_g_Text_replace_preg_ary, '                ',
                array(
                  array( 'notice', array( Display => 'showContent', text => array(
                    ...
                    '(• Aufarbeitung des Themas der Expansion und ihrer Rotverschiebung in einer Mail an Matthias Galke vom 20.04.2018, "Red Shift und Urknall". Hier nehme ich Bezug auf \\cite{Lineweaver:Urknall2005}.)',
                    ))),
