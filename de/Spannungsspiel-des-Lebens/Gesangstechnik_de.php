...
<?php FrQFT_f_HTML_BeginHeaderBodyContainer( 'OM:SpaLeb:Gesangstechnik'); ?>
      ...
      <?php FrQFT_f_Div_WrapperBegin( '      ', 'OM:SpaLeb:Koerperspannung'); ?>
          ...
          <?php To_f_Paragraph_list( $Sc_g_Text_replace_ary, $Sc_g_Text_replace_preg_ary, '                ',
                array(
                  ...
                  array( 'notice', array( Display => 'vis', text => array(
                    ...
                    '• Beide innere Federn des \\jump[][*Bearb]{OM:NPYo:Einleitung}{Naturphilosophie-Yoga} sollten beim Singen gespannt sein, das \\jump[][*Bearb]{OM:NPYo:Einleitung:YinYangKoerperspannung}{Yin und Yang der Körperspannung}',
                    //'• Ein agressives, verspanntes Gesicht ist vermutlich ein archaischer Reflex, um ein fauchendes und böses Gesicht zu machen. Dadurch verschiebt sich die Spannung in der Kopfmuskulatur wohl nach vorne. Es ist ein Ausdruck von Anspannung und Sorge/Angst. Wird dies im Alltag ständig getriggert, dann lässt wohl die Spannung der hinteren Kopfmuskulatur und die zum Öffnen der inneren Räume nach.',  // !!!: Ich glaube bei der Destruktion der Innenfeder im Kopf geht es um die Spannung der Kiefermuskulatur!
                    ...
                    '• Singen lernen als \\jump[][*Bearb]{OM:NPYo:Einleitung:ErkenneDichSelbst}{›Erkenne dich selbst‹ und Achtsamkeitsprozess}.',
                    ...
                    '• Nach Karin Ploog (Buch »voicecoaching«, Das Trainingskonzept für Gesangstechnik) soll man beim Einatmen das Zwerchfell entspannen, wenn ich richtig verstehe. Bei \\italic{Übung 3} sollen Di und Do und auch bei \\italic{Übung 5} sollen Lili und Leo je einen Impuls vom Zwerchfell erhalten, was eigentlich ein Impuls der ringförmigen Bauchmuskeln sein muss. Nach ihr wäre es genau anders herum, als nach \\jump[][*Bearb]{OM:SpaLeb:Koerperspannung:Atemspannung-und-Oberkoerperbalance}{meiner Erkenntnis und der allgemeinen Beschreibung der Atmung}: Hiernach wird beim Einatmen das Zwerchfell angespannt, aber natürlich nicht verspannt oder verkrampft.',
          ...
          <?php To_f_Chapter_v1( $Sc_g_Text_replace_ary, $Sc_g_Text_replace_preg_ary, '          ', 'invis',
            'OM:SpaLeb:Gesangstechnik:Uebungsvorbereitung',
              'Singen ist Leben', 'Sc_f_Paragraph',
                array(
                  array( 'jumplist', array(
                      array(  jump_name => 'OM:SpaLeb:Gesangstechnik', type => 'back'),
                    )),
                      
                  array( 'text', array( text => array(
                    'Die Vorschläge, die ich nachfolgend zur Übungsvorbereitung mache, sind dazu gedacht, nach und nach deinen Körper so zu erkennen und zu verändern,'."\n".
                    'dass es dir über die Zeit besser gelingt, die später vorgeschlagenen Gesangstechniken anzuwenden und deine ganz eigenen Techniken zu erarbeiten.'."\n".
                    'Es ist der Weg dahin, Achtsamkeit beim Singen zu praktizieren und darüber ein Bewusstsein für deinen Körper und deine Funktionsweise zu erlangen, die dir erlaubt,'."\n".
                    'dein eigenes, besonderes Talent zu entdecken.'."\n".
                    'Ich gebe dir Anregungen, welche Dinge den Klang deiner Stimme beeinflussen können.'."\n",
                      'Mit Achtsamkeit meine ich, dass du lernst dich und deinen Körper facettenreich wahrzunehmen, zu spüren, welche Veränderungen dich besser und sicherer fühlen lassen'."\n".
                    'sowie den Klang deiner Stimme beeinflussen und vielleicht schöner oder besser klingen lassen.'."\n".
                    'Nehme dir dafür die Zeit der Welt.'."\n".
                    'Es ist ein Try-And-Error-And-Success.'."\n".
                    'Jede Art von Druck kann kontraproduktiv sein.'."\n".
                    'Lass dir die Zeit meine Vorschläge und deine einen Eindrücke zu ergründen, sie zu variieren und eigenes auszuprobieren.'."\n".
                    'Denn jeder von uns ist anders.'."\n",
                      'Übernehme die Veränderungen, die dir gut tun und dir helfen in deinen Alltag.'."\n".
                    'Singen ist Leben.'."\n".
                    'Alles was dir beim Singen hilft verbessert generell deine Lebensqualität.'."\n".
                    'Ich war erstaunt, welchen positiven Einfluss viele alltägliche Übungen auf meinen Gesang haben, die ich überall wo es passt in mein Leben einbaue.'."\n".
                    'Wenn du das hinbekommst, dann ist es mehr als der halbe Weg zu gutem Gesang.'."\n".
                    'Denn vieles behindert uns beim Singen, was uns so erst einmal nicht bewusst ist.'."\n".
                    'Das kommt, weil uns das Wissen fehlt, also die Erfahrung und das Gefühl dafür, wie Atmung und Gesang funktionieren.'."\n".
                    'Eines sollte uns als erstes Bewusst sein:'."\n".
                    '\\quote{Unser Körper ist unser Instrument.}'."\n".
                    'Nur wenn unsere Stimmbänder recht frei und einigermaßen harmonisch schwingen können, und durch sie angregt unser Körper, kann ein guter Ton dabei herauskommen, den wir leicht unter Kontrolle haben.'."\n"))),
                ...
                'Lockerer Stand')),
                  array( 'notice', array( Display => 'vis', text => array(
                    ...
                    '• Arme eventuell nach außen rotieren, etwas ausbreiten und Handflächen dabei nach vorne drehen. Alles in Allem entsprich dies der \\jump[][*Bearb]{OM:NPYo:Einleitung:YinYangKoerperspannung:InnenFeder}{Innenfeder im Köprer des Naturphilosophie-Yoga}.',
                    ))),
                  array( 'text', array( text => array(
                    'XXX'."\n".
                    'XXX'."\n".
