<?php
  ...
  'OM:SpaLeb:Care-Prozess' =>
    array(
      ...
      keywords => '',
      text_titel_h1 => 'Der Care-Prozess \\\\ \\small{und Achtsamkeitsprozess} \\\\ \\color{*TitleAdd}{\\small{(Definition des Lebens)}}',
      text_titel_short => 'Care-Prozess',
      text_undertitel_h2 => 'Der zentrale Regelprozess der Lebewesen',
      ...
      jump_ary => array(
        'OM:SpaLeb:Care-Prozess:<init>' => array( Ani_init => ($FrQFT_g_Ani_idx = 0), Fig_init => ($FrQFT_g_Fig_idx = 0), Vid_init => ($FrQFT_g_Vid_idx = 0)),
                   
          'OM:SpaLeb:Care-Prozess:Vortext:Fig-Achtsamkeitsprozess' => array( headline_text => 'Abbildung '.(++$FrQFT_g_Fig_idx), headline_text_short => 'Abbildung '.($FrQFT_g_Fig_idx)),
        ...
        'OM:SpaLeb:Care-Prozess:ErweiSicht' => array( headline_text => 'Erweiterte Sicht', headline_text_short => 'Erweiterte Sicht'),
        'OM:SpaLeb:Care-Prozess:PhysAchtsa' => array( headline_text => 'Die Physik der Achtsamkeit\\hidden{Titelidee von Olli}', headline_text_short => 'Die Physik der Achtsamkeit'),
        'OM:SpaLeb:Care-Prozess:AchtsamkeitsprozesGrundlLeben' => array( headline_text => 'Zentraler Regelprozess des Lebens', headline_text_short => 'Zentraler Regelprozess des Lebens'),
        'OM:SpaLeb:Care-Prozess:NeueAnthropologie' => array( headline_text => 'Neue Anthropologie'/*, headline_text_short => ''*/),
        'OM:SpaLeb:Care-Prozess:KIundRobotik' => array( headline_text => 'Künstliche Intelligenz und Robotik', headline_text_short => 'Künstliche Intelligenz und Robotik'),
        'OM:SpaLeb:Care-Prozess:MystischeBedeutung' => array( headline_text => 'Mystische Bedeutung'/*, headline_text_short => 'XXX'*/),
      ),
    ),
