...
<?php FrQFT_f_HTML_BeginHeaderBodyContainer( 'OM:SpaLeb:Information-Kommunikation'); ?>
      ...
      <?php FrQFT_f_Div_WrapperBegin( '      ', 'OM:SpaLeb:Was-ist-Leben'); ?>
          ...
          <?php To_f_Paragraph_list( $Sc_g_Text_replace_ary, $Sc_g_Text_replace_preg_ary, '                ',
                ...
                'Information ist Wirkung', subline =>
                  ...
                  array( 'text', array( text => array(
                    'Ich denke, in diesem Fall können wir gar nicht oder nur sehr bedingt von Informationsübertragung sprechen.'."\n".
                    'Und zwar auch dann, wenn der Sender sich große Mühe gegeben hat, Informationen zu übertragen.'."\n".
                    'Von der Senderseite aus lässt sich der Begriff der Information also nur sehr schwer definieren.'."\n",
                      'Dem Sender erscheint seine Nachricht selber natürlich als Information, wobei er aber nicht sagen kann, ob er sie so verpackt hat,'."\n".
                    'dass sie vom Empfänger verstanden werden muss.'."\n".
                ...
                'Information kann „zufällig“ übertragen werden', subline =>
                  ...
                  array( 'text', array( text => array(
                    'Definieren wir die Information über die Wirkung auf den Empfänger, so ergibt sich dann ganz generell folgende Möglichkeit:'."\n",
                      'Ich kann als Empfänger in den Wolken das Gesicht meiner verstorbenen Großmutter erkennen und den Eindruck haben, es möchte mir etwas mitteilen.'."\n".
                    'Information ist also abhängig von meinem inneren Zustand, von meiner Erfahrung, von dem, was ich gelernt habe.'."\n",
                ...
                'Resonanz geht mit sinnvoller Kommunikation einher', subline =>
                  ...
                  array( 'text', array( text => array(
                    'Je ähnlicher sich Sender und Empfänger in ihrer Sprache sind, desto sinnvoller kann ihre Kommunikation sein:'."\n",
                      'Erst, wenn der Sender in Resonanz mit dem Empfänger geht, der Empfänger also auch zum Sender wird und der Sender wiederum zum Empfänger,'."\n".
                ...
                'Lebewesen sind in Selbstresonanz', subline =>
                  '')),
                  array( 'text', array( text => array(
                    'Eine der wesentlichen Eigenschaften von Lebewesen ist, dass sie mit sich selber stark in Resonanz sind, eine intensive innere Kommunikation besitzen;'."\n".
