          ...
          <?php To_f_Paragraph_list( $Sc_g_Text_replace_ary, $Sc_g_Text_replace_preg_ary, '                ',
                ...
                'Eine Entwicklung in Helixspiralform', subline =>
                  ...
                  array( 'text', array( Shape  => 'italic', text => array(
                      ...
                      'Wir lernen, wer wir in unserem Lebenskontext sind, wie wir in uns und in unserer Umwelt funktionieren.'."\n".
                ...
                'Der Prozess unseres Lebens – unser Gedeihen', subline =>
                  ...
                  array( 'text', array( text => array(
                    'Wir atmen, wir essen, wir schlafen, wir haben soziale Kontakte, wir pflanzen uns fort und vieles andere mehr.'."\n".
                    'All dies wird von unserem Achtsamkeitsprozess geregelt.'."\n",
                      'Durch die Verknüpfung mit unseren biologischen Regelprozessen wird auch unser Wachstum geregelt, unsere körperliche und geistige Entwicklung, unser Gedeihen.'."\n".
                ...
                'Elementares, rudimentäres und kognitives Bewusstsein', subline =>
                  ...
                  '\\condb{Elementares Bewusstsein – nicht unbedingt Leben} \\\\'."\n".
                    ...
                    'Jemand schubst uns beispielsweise unerwartet und wir kommen ins Trudeln.'."\n",
                      ...
                      'In der neuen Physik haben auf diese Weise dann auch alle Elementarteilchen elementares Bewusstsein, wie Elektronen, die über ihre elektrische Ladung'."\n".
                  ...
                  '\\condb{Kognitives Bewusstsein – der kognitive Achtsamkeitsprozess} \\\\'."\n".
                    ...
                    'Hierbei ist zwischen einer durch vorheriges Lernen quasi fest verdrahteten Reaktion – einer Art von komplexem Reflex – und einer Reaktion durch einen neuen Lernprozess zu unterscheiden.'."\n",
                ...
                'Unser Körper gehört zu unserem Bewusstsein, Wissen und Können', subline =>
                  '')),
                  array( 'text', array( text => array(
                    'Eine besondere Erkenntnis gewinnen wir, wenn wir uns vorstellen, welche Bedeutung das Bewusstsein und Wissen bei einer körperlichen Handlung'."\n".
                    'und deren Übergang in oder deren Wirkung auf unsere Lebenssituation hat.'."\n",
                      'Welche Wirkung unsere körperliche Handlung auf unsere Lebenssituation hat, hängt nämlich von unserer körperlichen Struktur ab.'."\n".
                    'Tun wir etwas mit unseren Armen, dann ist es ein gravierender Unterschied für unsere zukünftige Lebenssituation, wie stark unsere Arme sind'."\n".
                    'oder ob unsere Knochen vielleicht gar aus Gummi bestehen oder brechen.'."\n",
                      'Die physische Kondition unseres Körpers ist ein Teil unseres Bewusstseins und unseres Wissens.'."\n".
                    'Deshalb können wir mit Fug und Recht sagen, dass unser Körper etwas lernen kann.'."\n".
                ...
                'Unterprozesse des führenden Achtsamkeitsprozesses', subline =>
                  ...
                  array( 'text', array( text => array(
                    ...
                    'Die Handlung unseres Denkens hat einen Inhalt, der selber wieder ein Achtsamkeitsprozess auf Probe sein kann.'."\n",
                ...
                'Wie können wir uns eine Balance aus Stabilität und Fortschritt vorstellen?')),
                  array( 'text', array( text => array(
                    'Wenn wir gehen, dann wird vieles von dem sichtbar, was damit gemeint ist:'."\n",
                      'Einen Schritt zu machen geht nur, wenn wir unsere Stabilität des geraden, aufrechten Stands verlassen.'."\n".
                    'Wir lassen uns nach vorne kippen.'."\n".
                    'Doch bevor wir richtig fallen, setzen wir einen Fuß vor, um unseren Fall abzufangen und ziehen den Stehengebliebenen nach, um wieder in einen stabilen Stand zu kommen.'."\n",
                      'Beim Gehen werden mehrere Schritte so miteinander verbunden, dass wir in Wellenform zwischen Stabilität und Fortschritt wechseln.'."\n".
                    'Es wird also ständig zwischen Stabilität und Fortschritt balanciert.'."\n",
                      'Balancieren wir einen Stab auf unserem Finger, dann hat dies auch wellenförmige Wechsel zwischen stabilen und weniger stabilen Lagen des Stabs.'."\n".
                    'Er kippt und wir tarieren dies wieder aus.'."\n".
                    'Alle Regelprozesse funktionieren genau so.'."\n"))),
                  array( 'text', array( text => array(
                    'Nur so können Fortschritte, also Wachstum und Persönlichkeitsentwicklung, stattfinden.'."\n".
