...
<?php FrQFT_f_HTML_BeginHeaderBodyContainer( 'OM:SpaLeb:KIundRobotik'); ?>
          ...
          <?php To_f_Paragraph_list( $Sc_g_Text_replace_ary, $Sc_g_Text_replace_preg_ary, '                ',
                array(
                  array( 'notice', array( Display => 'showContent', text => array(
                    ...
                    '\\bold{Analyse:}',
                    '• Der Gödelsche Unvollständigkeitssatz zeigt: „Jedes hinreichend mächtige, rekursiv aufzählbare formale System ist entweder widersprüchlich oder unvollständig.“, siehe Wikipedia',
                    '– Diese Unvollständigkeit zeigt sich im Besonderen in selbstbezüglichen Sätzen.',
                    '– Der Mensch, seine Gedanken und sein Verstand, wie die ganze Natur, denke ich, ist in sich hochgradig selbstbezüglich.',
                    '– Die Grundlage der KI ist mathematische Informatik, die nach meinem Verständnis dem Gödelschen Unvollständigkeitssatz unterliegt.',
                    '– Dieses Verständnis legt sehr nahe, dass die KI nicht in der Lage ist, den menschlichen Verstand und das menschliche Wesen in sehr hoher Güte zu simulieren.',
                  ...
                  array( 'jumplist', array(
                      array(  jump_name => 'OM:SpaLeb:Diskussion'),
                    )),
                )
          ); ?>
		    	<br>
