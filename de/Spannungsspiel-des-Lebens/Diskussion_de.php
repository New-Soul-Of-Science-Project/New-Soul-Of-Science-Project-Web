...
<?php FrQFT_f_HTML_BeginHeaderBodyContainer( 'OM:SpaLeb:Diskussion'); ?>
      ...
      <?php FrQFT_f_Div_WrapperBegin( '      ', 'OM:SpaLeb:Home'); ?>
          ...
          <?php To_f_Chapter_v1( $Sc_g_Text_replace_ary, $Sc_g_Text_replace_preg_ary, '          ', 'hideContent',
            'OM:SpaLeb:Diskussion:Achtsamkeit',
              '', 'Sc_f_Paragraph',
                array(
                  array( 'jumplist', array(
                      array(  jump_name => 'OM:SpaLeb:Diskussion', type => 'back'),
                    )),
                  ...
                  array( 'notice', array( Display => 'showContent', text => array(
                    ...
                    '• \quote{Achtsamkeit bedeutet, die eigenen Gedanken auf den Moment zu konzentrieren.} \quote{Das bedeutet, den Moment zu erleben, ohne ihn zu bewerten oder sich gefühlsmäßig davon fortreißen zu lassen.} \quote{Achtsamkeit ist ein Zustand, in dem wir unsere Gedanken vollkommen auf das Hier und Jetzt konzentrieren – ohne darüber zu urteilen oder emotional darauf zu reagieren.} Siehe Spektrum Kompakt. Achtsamkeit und Empathie. 04.07.2016. Augenblick mal! (aus Gehirn und Geist, 11/2013) S. 4-12, hier S. 5. \quote{Ein ganzes Arsenal von Übungen soll die Aufmerksamkeit stärker auf konkrete Wahrnehmungen des Hier und Jetzt lenken und so zu mehr Klarsicht und Ruhe verhelfen.} Ebenda, hier S. 6.',
                    ))),
                ...
                'Der Achtsamkeitsprozess')),
                  array( 'text', array( text => array(
                    ...
                    'Der Achtsamkeitsprozess bezieht sich wirklich nur auf das Wechselspiel der Selbstwahrnehmung, und im Besonderen des Sich-Selber-Spürens und -Fühlens, und seinem eigenen Handeln,'."\n".
                    'im Hinblick darauf, was das Handeln mit einem macht.'."\n".
                    'Dies hat zur Folge, das man allgemein Achtsamer wird und auch die Blumen am Wegesrand besser und deutlicher wahrnimmt.'."\n".
                    'Doch dies ist kein Teil des \italic{einfachen Achtsamkeitsprozesses}.'."\n".
                    'Der \italic{externe Achtsamkeitsprozess} bezieht das Wechselspiel zwischen einem selbst und der Umwelt mit ein.'."\n".
                    'Doch auch nur im Hinblick auf das eingene Handeln, nun inklusive der Wahrnehmung der Umwelt, und was dies mit der Umwelt und darüber mit einem macht.'."\n".
                    'Wie es das eigene Gefühl erzeugt und verändert.'."\n".
                    'Dabei ist die Wahrnehmung der Umwelt eben Teil des Handelns.'."\n".
