          ...
          <?php To_f_Paragraph_list( $Sc_g_Text_replace_ary, $Sc_g_Text_replace_preg_ary, '                ',
                array(
                  array( 'text', array( text => array(
                    ...
                    'die dann die Eigenschaften eines \jump{OM:SupNum:Algebraische-Grundlagen:SIstKoerper}{algebraischen Körpers} besitzen.'."\n",
                ...
                'Information')),
                  array( 'text', array( text => array(
                    ...
                    'Bitte wähle den direkten Zugang zu den einzelnen Themen über das nachfolgende \\jump{OM:BiOrd:Home:Inhalt}{Inhaltsverzeichnis}.'."\n".
