...
<?php FrQFT_f_HTML_BeginHeaderBodyContainer( 'OM:VRT:Laengenkontraktion-Bewegung'); ?>
      ...
      <?php FrQFT_f_Div_WrapperBegin( '      ', 'OM:VRT:Einleitung'); ?>
          ...
          <?php To_f_Paragraph_list( $Sc_g_Text_replace_ary, $Sc_g_Text_replace_preg_ary, '                ',
                array(
                  array( 'notice', array( Display => 'showContent', text => array(
                    ...
                    '• Lorentzkontraktion!',
                    '– Als Kontraktion von Feldern.\\footnote{\\const{FrQFT_g_footnote_text_LorentzKontrFelder}}',
                    '• Das Kapitel \\jumpname{OM:FrQFT:Gravitation:Laengenkontraktion-im-Gravitationsfeld} berücksichtigen!',
                    ))),
          ...
          <?php To_f_Chapter_v1( $Sc_g_Text_replace_ary, $Sc_g_Text_replace_preg_ary, '          ', 'hideContent',
            'OM:VRT:Laengenkontraktion-Bewegung:XXX',
              '\\color{*Bearb}{In Arbeit …}', 'Sc_f_Paragraph',
                array(
                  array( 'jumplist', array(
                      //array(  jump_name => 'OM:VRT:XXX', type => 'back'),
                    )),
