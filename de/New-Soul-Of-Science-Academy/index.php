...
<?php FrQFT_f_HTML_BeginHeaderBodyContainer( 'OM:nSOSa:Home'); ?>
          ...
          <?php To_f_Paragraph_list( $Sc_g_Text_replace_ary, $Sc_g_Text_replace_preg_ary, '                ',
                ...
                'Die Grundlagenphysik aus Sicht von Regelprozessen', subline =>
                  ...
                  array( 'jumplist', array(
                      array(  jump_name => 'OM:nSOSa:Home:Inhalt'),
                      // array(  jump_name => 'OM:SpaLeb:Vorwort'),
                      // array(  jump_name => 'OM:nSOSa:Einleitung'),
                    )),
                )
          ); ?>
		    	<br>
          ...
          <?php To_f_Chapter_v1( $Sc_g_Text_replace_ary, $Sc_g_Text_replace_preg_ary, '          ', 'hideContent',
            'OM:nSOSa:Home:Inhalt',
              '', 'Sc_f_Paragraph',
		    	...
		    	<!  • Lexikon:  >
          <?php To_f_headline_add_hides_begin( 'Lexikon', 'Lexikon', 'OM:nSOSa:Home:Lexikon', '          ', 'hideContent'); ?>
            <br>
